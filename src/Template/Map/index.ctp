...
<div class="modal fade" id="inventory_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header"></div>
			<div class="modal-body">
				<div id='loader_image'><img src='/img/ajax-loader.gif'></div>
				<div id='items_tablist'></div>
			</div>
...
//		$('#displaydiv').append("<img src='" + background.src + "' id='bgimage' width='" + $('#displaydiv').width() + "' height='" + $('#displaydiv').height() + "'>");
		...
		$(".locationdiv").click(function () {
			...
			$("#items_tablist").load("/map/displaysd", function () {
		...
		$(".routediv").click(function () {
			$("#items_tablist").hide();
			var dataid = $(this).data('id');
			$("#items_tablist").load("/map/displayroute", function () {
				$('#loader_image').show();
				...
				$.getJSON("/map/routeinventories/" + dataid, function (invn) {
					...
					load_inventory_images(function () {
						$('#loader_image').hide();
						$('#items_tablist').width(bg_width).show();
					});
				});
			});
		});
	...
	function add_image(image_array, offset_top, offset_left) {
		...
		imgstr += "'>";
		imgstr += "<img src='" + image_array['src'] + "' class='" + image_array['iconclass'];
		imgstr += "'";
		imgstr += " style='";
		imgstr += " height: " + image_array['size'] + "px;";
		imgstr += " width: " + image_array['size'] + "px;";
